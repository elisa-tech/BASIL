...
const Signin: React.FunctionComponent = () => {
  ...
  React.useEffect(() => {
   ...
   const formSubmit = () => {
       ...
       if (auth.isLogged()){
         setAlertMessage('You are already loogin in as ' + auth.userEmail); return;
       }

       if (validateEmailValue != 'success'){
           setAlertMessage('Email is mandatory.'); return;
       } else if (validatePasswordValue != 'success'){
           setAlertMessage('Passord is mandatory.'); return;
       } else if (validatePasswordConfirmValue != 'success'){
           setAlertMessage('Password Confirm is mandatory.'); return;
       } else if (validatePasswordValues != 'success'){
           setAlertMessage('Password fields are not the same.'); return;
       } else {
          setAlertMessage('');
       }
